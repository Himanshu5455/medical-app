...
const ChatInput = ({ question, currentAnswer, onAnswer, disabled, isStreamingActive }) => {
...
const handleSubmit = (value = inputValue) => {
  ...
  if (question.type === "file") {
    ...
    // Convert Date -> "YYYY-MM-DD" string to keep Redux state serializable
    submitValue =
      value instanceof Date
        ? value.toISOString().split("T")[0] // e.g. "2025-09-15"
        : value || "";
  } else {
    submitValue = value;
  }
...
//                 width: 40,
//                 height: 40,
//                 flexShrink: 0, // Don't let icon shrink
//                 '&:hover': { 
...
//               disabled={disabled || !inputValue.trim() || isStreamingActive}
//               sx={{
//                 bgcolor: '#125A67',
...
//       case 'boolean':
//       case 'select':
//         // For boolean and select questions, show text input since options are in chat
//         return (
//           <Box sx={{ 
//             display: 'flex', 
//             gap: 1, 
...
//                 <Typography variant="caption" sx={{ mb: 0.5, color: '#374151', display: 'block' }}>
//                   Files: {files.length}
//                 </Typography>
//                 <List dense sx={{ py: 0 }}>
//                   {files.map((file, index) => (
//                     <ListItem key={index} sx={{ px: 0, py: 0.25 }}>
//                       <AttachFileIcon sx={{ mr: 0.5, color: '#125A67', fontSize: 14 }} />
//                       <ListItemText
//                         primary={file.name}
