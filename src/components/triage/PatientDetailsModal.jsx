...
//     if (!position) {
//       return { position: 'fixed', top: '50%', left: '70%', transform: 'translate(-50%, -50%)' };
//     }
              ...
              {files.length === 0 ? (
                ...
                files.map((file, idx) => (
                  <Grid item xs={6} key={idx}>
                    ...
                    >
                      <CloudUploadIcon sx={{ color: COLORS.error, fontSize: 36, mb: 1 }} />
                      <Typography
                        variant="body2"
                        sx={{ fontWeight: 500, wordBreak: 'break-word', color: COLORS.textPrimary }}
                      >
                        {file.name}
                      </Typography>
                      <Typography variant="caption" sx={{ color: COLORS.textSecondary }}>
                        {new Date(file.date || patient.referral_date || Date.now()).toLocaleString()}
                      </Typography>
                    </Box>
                  </Grid>
                ))
  ...
  >
    ...
    <Typography
      ...
      sx={{
        ...
        fontWeight: 500,
        wordBreak: "break-word",
        maxWidth: "150px", // 👈 Adjust width as you like
        overflow: "hidden",
